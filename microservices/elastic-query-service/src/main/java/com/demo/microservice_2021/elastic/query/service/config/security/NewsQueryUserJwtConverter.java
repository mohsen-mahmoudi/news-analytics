...
public class NewsQueryUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {

    private static final Logger LOG = LoggerFactory.getLogger(NewsQueryUserJwtConverter.class);
    ...
    public NewsQueryUserJwtConverter(NewsQueryUserDetailsService newsQueryUserDetailsService) {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        return Optional
                .ofNullable(newsQueryUserDetailsService.loadUserByUsername(jwt.getClaimAsString(USERNAME_CLAIM)))
                .map(userDetails -> {
                    ((NewsQueryUser) userDetails).setAuthorities(authoritiesFromJwt);

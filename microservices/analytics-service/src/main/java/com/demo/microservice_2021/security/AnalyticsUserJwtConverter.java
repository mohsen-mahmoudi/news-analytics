...
public class AnalyticsUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AnalyticsUserJwtConverter.class);
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        return Optional
                .ofNullable(analyticsUserDetailsService.loadUserByUsername(jwt.getClaimAsString(USERNAME_CLAIM)))
                .map(userDetails -> {

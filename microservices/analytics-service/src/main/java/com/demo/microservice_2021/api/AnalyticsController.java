package com.demo.microservice_2021.api;

import com.demo.microservice_2021.dto.AnalyticsResponseModel;
import com.demo.microservice_2021.service.AnalyticsService;
...
public class AnalyticsController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success.", content = {
                    @Content(schema = @Schema(implementation = AnalyticsResponseModel.class))
            }),
